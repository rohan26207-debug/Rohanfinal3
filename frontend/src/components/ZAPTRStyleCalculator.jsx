...
const ZAPTRStyleCalculator = () => {
  ...
  const generateExportContent = () => {
    ...
    if (todaySales.length > 0) {
      ...
      content += '<th style="border: 1px solid #333; padding: 8px 10px; font-size: 11px; font-weight: bold; text-align: center; font-family: Arial, sans-serif;">Start</th>';
      content += '<th style="border: 1px solid #333; padding: 8px 10px; font-size: 11px; font-weight: bold; text-align: center; font-family: Arial, sans-serif;">End</th>';
