...
const ZAPTRStyleCalculator = () => {
  ...
  const generateExportContent = () => {
    ...
    if (todaySales.length > 0) {
      ...
      content += '<th style="background-color: #f2f2f2; border: 1px solid #ccc; padding: 8px 12px; font-size: 11px; font-weight: bold; text-align: center;">Start</th>';
      content += '<th style="background-color: #f2f2f2; border: 1px solid #ccc; padding: 8px 12px; font-size: 11px; font-weight: bold; text-align: center;">End</th>';
