...
const ZAPTRStyleCalculator = () => {
    ...
    try {
      ...
      const htmlContent = `
        <div style="font-family: Arial, sans-serif; padding: 15px;">
          <h1 style="text-align: center; color: #333; margin-bottom: 10px; font-size: 22px; font-weight: bold;">M.Pump Calc Daily Report</h1>
          <h2 style="text-align: center; color: #666; margin-bottom: 15px; font-size: 17px;">Date: ${selectedDate}</h2>
          
          <div style="margin: 12px 0; border: 1px solid #ccc; padding: 10px;">
            <h3 style="color: #333; margin-bottom: 10px; font-size: 17px; font-weight: bold;">Daily Summary</h3>
            <table style="width: 100%; border-collapse: collapse;">
              ${Object.entries(stats.fuelSalesByType).map(([fuelType, data], index) => 
                `<tr><td style="padding: 5px 7px; border-bottom: 1px solid #ddd; font-size: 13px;"><strong>${index + 1}. ${fuelType} Sales:</strong></td><td style="padding: 5px 7px; border-bottom: 1px solid #ddd; font-size: 13px; font-weight: bold;">${data.liters.toFixed(2)}L • ₹${data.amount.toFixed(2)}</td></tr>`
              ).join('')}
              ${Object.keys(stats.fuelSalesByType).length > 1 ? 
                `<tr><td style="padding: 5px 7px; border-bottom: 1px solid #ddd; font-size: 13px;"><strong>Total Reading Sales:</strong></td><td style="padding: 5px 7px; border-bottom: 1px solid #ddd; font-size: 13px; font-weight: bold;">${stats.totalLiters.toFixed(2)}L • ₹${stats.fuelCashSales.toFixed(2)}</td></tr>` : ''
              }
              <tr><td style="padding: 5px 7px; border-bottom: 1px solid #ddd; font-size: 13px;"><strong>${Object.keys(stats.fuelSalesByType).length + (Object.keys(stats.fuelSalesByType).length > 1 ? 2 : 1)}. Credit Sales:</strong></td><td style="padding: 5px 7px; border-bottom: 1px solid #ddd; font-size: 13px; font-weight: bold;">${stats.creditLiters.toFixed(2)}L • ₹${stats.creditAmount.toFixed(2)}</td></tr>
              <tr><td style="padding: 5px 7px; border-bottom: 1px solid #ddd; font-size: 13px;"><strong>${Object.keys(stats.fuelSalesByType).length + (Object.keys(stats.fuelSalesByType).length > 1 ? 3 : 2)}. Income:</strong></td><td style="padding: 5px 7px; border-bottom: 1px solid #ddd; font-size: 13px; font-weight: bold;">₹${stats.otherIncome.toFixed(2)}</td></tr>
              <tr><td style="padding: 5px 7px; border-bottom: 1px solid #ddd; font-size: 13px;"><strong>${Object.keys(stats.fuelSalesByType).length + (Object.keys(stats.fuelSalesByType).length > 1 ? 4 : 3)}. Expenses:</strong></td><td style="padding: 5px 7px; border-bottom: 1px solid #ddd; font-size: 13px; font-weight: bold;">₹${stats.totalExpenses.toFixed(2)}</td></tr>
              <tr><td style="padding: 5px 7px; border-bottom: 1px solid #ddd; font-size: 13px;"><strong>${Object.keys(stats.fuelSalesByType).length + (Object.keys(stats.fuelSalesByType).length > 1 ? 5 : 4)}. Cash in Hand:</strong></td><td style="padding: 5px 7px; border-bottom: 1px solid #ddd; font-size: 13px; font-weight: bold;">₹${stats.adjustedCashSales.toFixed(2)}</td></tr>
            </table>
          </div>
  ...
  const generateExportContent = () => {
    ...
    if (todaySales.length > 0) {
      ...
      content += '<h3 style="color: #000000; font-size: 17px; margin-bottom: 8px;">Fuel Sales (' + todaySales.length + ')</h3>';
      ...
      content += '<th style="border: 1px solid #999; padding: 5px; font-size: 12px; text-align: center;">Description</th>';
      content += '<th style="border: 1px solid #999; padding: 5px; font-size: 12px; text-align: center;">Start</th>';
      content += '<th style="border: 1px solid #999; padding: 5px; font-size: 12px; text-align: center;">End</th>';
      ...
      todaySales.forEach((sale, index) => {
        ...
        content += `<td style="border: 1px solid #ccc; padding: 4px; font-size: 12px;">${sale.nozzle} - ${sale.fuelType}</td>`;
        content += `<td style="border: 1px solid #ccc; padding: 4px; font-size: 12px; text-align: right;">${sale.startReading}</td>`;
        content += `<td style="border: 1px solid #ccc; padding: 4px; font-size: 12px; text-align: right;">${sale.endReading}</td>`;
        content += `<td style="border: 1px solid #ccc; padding: 4px; font-size: 12px; text-align: right;">₹${sale.rate}</td>`;
        content += `<td style="border: 1px solid #ccc; padding: 4px; font-size: 12px; text-align: right;">${sale.liters.toFixed(2)}</td>`;
        content += `<td style="border: 1px solid #ccc; padding: 4px; font-size: 12px; text-align: right;">₹${sale.amount.toFixed(2)}</td>`;
        content += '</tr>';
      });
      content += '</tbody>';
      content += '</table>';
    ...
    if (todayCredits.length > 0) {
      ...
      content += '<h3 style="color: #000000; font-size: 14px; margin-bottom: 6px;">Credit Sales (' + todayCredits.length + ')</h3>';
      ...
      content += '<th style="border: 1px solid #999; padding: 4px; font-size: 10px; text-align: center;">Customer</th>';
      content += '<th style="border: 1px solid #999; padding: 4px; font-size: 10px; text-align: center;">Vehicle</th>';
      ...
      todayCredits.forEach((credit, index) => {
        ...
        content += `<td style="border: 1px solid #ccc; padding: 3px; font-size: 10px;">${credit.customerName}</td>`;
        content += `<td style="border: 1px solid #ccc; padding: 3px; font-size: 10px;">${credit.vehicleNumber || 'N/A'}</td>`;
        content += `<td style="border: 1px solid #ccc; padding: 3px; font-size: 10px; text-align: right;">${credit.liters.toFixed(2)}</td>`;
        content += `<td style="border: 1px solid #ccc; padding: 3px; font-size: 10px; text-align: right;">₹${credit.rate}</td>`;
        content += `<td style="border: 1px solid #ccc; padding: 3px; font-size: 10px; text-align: right;">₹${credit.amount.toFixed(2)}</td>`;
        content += '</tr>';
      });
      content += '</tbody>';
      content += '</table>';
    ...
    if (todayExpenses.length > 0) {
      content += '<div style="margin: 12px 0;">';
      content += '<h3 style="color: #000000; font-size: 14px; margin-bottom: 6px;">Expenses (' + todayExpenses.length + ')</h3>';
      content += '<table style="width: 100%; border-collapse: collapse; margin-bottom: 8px;">';
      content += '<thead>';
      content += '<tr style="background-color: #f5f5f5;">';
      content += '<th style="border: 1px solid #999; padding: 4px; font-size: 10px; text-align: center;">Sr.</th>';
      ...
      todayExpenses.forEach((expense, index) => {
        content += '<tr>';
        content += `<td style="border: 1px solid #ccc; padding: 3px; font-size: 10px; text-align: center;">${index + 1}</td>`;
        content += `<td style="border: 1px solid #ccc; padding: 3px; font-size: 10px;">${expense.description}</td>`;
        content += `<td style="border: 1px solid #ccc; padding: 3px; font-size: 10px; text-align: right;">₹${expense.amount.toFixed(2)}</td>`;
        content += '</tr>';
      });
      content += '</tbody>';
      content += '</table>';
