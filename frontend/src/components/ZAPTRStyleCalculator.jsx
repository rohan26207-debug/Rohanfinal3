...
const ZAPTRStyleCalculator = () => {
        ...
        <div style="font-family: Arial, sans-serif; padding: 20px;">
          ...
          <div style="margin: 20px 0; border: 2px solid #ddd; padding: 20px; border-radius: 8px; background-color: #f8f9fa;">
            ...
            <table style="width: 100%; border-collapse: collapse; font-size: 16px;">
              ...
              <tr><td style="padding: 12px 8px; border-bottom: 1px solid #ddd; font-size: 16px;"><strong>${Object.keys(stats.fuelSalesByType).length + (Object.keys(stats.fuelSalesByType).length > 1 ? 2 : 1)}. Credit Sales:</strong></td><td style="padding: 12px 8px; border-bottom: 1px solid #ddd; font-size: 16px; font-weight: bold;">${stats.creditLiters.toFixed(2)} • ₹${stats.creditAmount.toFixed(2)}</td></tr>
  ...
  const generateExportContent = () => {
    ...
    if (todaySales.length > 0) {
      ...
      content += '<h3 style="color: #000000; font-size: 32px; margin-bottom: 15px;">Fuel Sales (' + todaySales.length + ')</h3>';
      content += '<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">';
      content += '<thead>';
      content += '<tr style="background-color: #ffffff;">';
      content += '<th style="border: 1px solid #000000; padding: 10px; font-size: 18px; text-align: center; background-color: #ffffff; color: #000000;">Sr.No</th>';
      content += '<th style="border: 1px solid #000000; padding: 10px; font-size: 18px; text-align: center; background-color: #ffffff; color: #000000;">Description</th>';
      content += '<th style="border: 1px solid #000000; padding: 10px; font-size: 18px; text-align: center; background-color: #ffffff; color: #000000;">Start</th>';
      content += '<th style="border: 1px solid #000000; padding: 10px; font-size: 18px; text-align: center; background-color: #ffffff; color: #000000;">End</th>';
      content += '<th style="border: 1px solid #000000; padding: 10px; font-size: 18px; text-align: center; background-color: #ffffff; color: #000000;">Rate</th>';
      content += '<th style="border: 1px solid #000000; padding: 10px; font-size: 18px; text-align: center; background-color: #ffffff; color: #000000;">Litres</th>';
      content += '<th style="border: 1px solid #000000; padding: 10px; font-size: 18px; text-align: center; background-color: #ffffff; color: #000000;">Amount</th>';
      content += '</tr>';
      content += '</thead>';
      content += '<tbody>';
      todaySales.forEach((sale, index) => {
        ...
        content += `<td style="border: 1px solid #000000; padding: 8px; font-size: 16px; text-align: right; color: #000000;">${sale.startReading}</td>`;
        content += `<td style="border: 1px solid #000000; padding: 8px; font-size: 16px; text-align: right; color: #000000;">${sale.endReading}</td>`;
        content += `<td style="border: 1px solid #000000; padding: 8px; font-size: 16px; text-align: right; color: #000000;">₹${sale.rate}</td>`;
        content += `<td style="border: 1px solid #000000; padding: 8px; font-size: 16px; text-align: right; color: #000000;">${sale.liters.toFixed(2)}</td>`;
    ...
    if (todayCredits.length > 0) {
      content += '<div style="margin: 25px 0;">';
      content += '<h3 style="color: #000000; font-size: 32px; margin-bottom: 15px;">Credit Sales (' + todayCredits.length + ')</h3>';
      content += '<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">';
      content += '<thead>';
      content += '<tr style="background-color: #ffffff;">';
      content += '<th style="border: 1px solid #000000; padding: 10px; font-size: 18px; text-align: center; background-color: #ffffff; color: #000000;">Sr.No</th>';
    ...
    if (todayIncome.length > 0) {
      content += '<div style="margin: 25px 0;">';
      content += '<h3 style="color: #000000; font-size: 32px; margin-bottom: 15px;">Income (' + todayIncome.length + ')</h3>';
      content += '<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">';
      content += '<thead>';
      content += '<tr style="background-color: #ffffff;">';
      content += '<th style="border: 1px solid #000000; padding: 10px; font-size: 18px; text-align: center; background-color: #ffffff; color: #000000;">Sr.No</th>';
      ...
      todayIncome.forEach((income, index) => {
        content += '<tr>';
        content += `<td style="border: 1px solid #000000; padding: 8px; font-size: 16px; text-align: center; color: #000000;">${index + 1}</td>`;
        content += `<td style="border: 1px solid #000000; padding: 8px; font-size: 16px; color: #000000;">${income.description}</td>`;
        content += `<td style="border: 1px solid #000000; padding: 8px; font-size: 16px; text-align: right; color: #000000;">₹${income.amount.toFixed(2)}</td>`;
        content += '</tr>';
      });
      content += '</tbody>';
      content += '</table>';
    ...
    if (todayExpenses.length > 0) {
      content += '<div style="margin: 25px 0;">';
      content += '<h3 style="color: #000000; font-size: 32px; margin-bottom: 15px;">Expenses (' + todayExpenses.length + ')</h3>';
      content += '<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">';
      content += '<thead>';
      content += '<tr style="background-color: #ffffff;">';
      content += '<th style="border: 1px solid #000000; padding: 10px; font-size: 18px; text-align: center; background-color: #ffffff; color: #000000;">Sr.No</th>';
      ...
      todayExpenses.forEach((expense, index) => {
        content += '<tr>';
        content += `<td style="border: 1px solid #000000; padding: 8px; font-size: 16px; text-align: center; color: #000000;">${index + 1}</td>`;
        content += `<td style="border: 1px solid #000000; padding: 8px; font-size: 16px; color: #000000;">${expense.description}</td>`;
        content += `<td style="border: 1px solid #000000; padding: 8px; font-size: 16px; text-align: right; color: #000000;">₹${expense.amount.toFixed(2)}</td>`;
        content += '</tr>';
      });
      content += '</tbody>';
      content += '</table>';
  ...
  const generateCSVContent = () => {
    ...
    Object.entries(stats.fuelSalesByType).forEach(([fuelType, data], index) => {
      csv += `${index + 1}. ${fuelType} Sales,${data.liters.toFixed(2)} • ₹${data.amount.toFixed(2)}\n`;
    });
    ...
    csv += `${Object.keys(stats.fuelSalesByType).length + (Object.keys(stats.fuelSalesByType).length > 1 ? 2 : 1)}. Credit Sales,${stats.creditLiters.toFixed(2)} • ₹${stats.creditAmount.toFixed(2)}\n`;
  ...
  const generateTextContent = () => {
    ...
    // Add total if multiple fuel types
    if (Object.keys(stats.fuelSalesByType).length > 1) {
      text += `• Total Reading Sales: ${stats.totalLiters.toFixed(2)} • ₹${stats.fuelCashSales.toFixed(2)}\n`;
    }
    
    text += `• ${Object.keys(stats.fuelSalesByType).length + (Object.keys(stats.fuelSalesByType).length > 1 ? 2 : 1)}. Credit Sales: ${stats.creditLiters.toFixed(2)} • ₹${stats.creditAmount.toFixed(2)}\n`;
                ...
                <div className={`flex items-center justify-between py-3 px-4 rounded-lg ${
                  ...
                  <div className="text-right">
                    <div className={`text-lg font-bold ${
                      ...
                      {stats.totalLiters.toFixed(2)} • ₹{stats.fuelCashSales.toFixed(2)}
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className={`flex items-center justify-between py-3 px-4 rounded-lg ${
                ...
                <div className="text-right">
                  <div className={`text-lg font-bold ${
                    ...
                    {stats.creditLiters.toFixed(2)} • ₹{stats.creditAmount.toFixed(2)}
                  </div>
                </div>
              </div>
