...
const ZAPTRStyleCalculator = () => {
  ...
  const generateExportContent = () => {
    ...
    if (todaySales.length > 0) {
      ...
      content += '<th style="background-color: #f2f2f2; border: 1px solid #999; padding: 12px 16px; font-size: 13px; font-weight: bold; text-align: center;">Start</th>';
      content += '<th style="background-color: #f2f2f2; border: 1px solid #999; padding: 12px 16px; font-size: 13px; font-weight: bold; text-align: center;">End</th>';
