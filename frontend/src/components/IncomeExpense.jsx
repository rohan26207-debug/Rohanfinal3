...
const IncomeExpense = ({ isDarkMode, incomeData, addIncomeRecord, deleteIncomeRecord, expenseData, addExpenseRecord, deleteExpenseRecord, selectedDate, salesData, creditData }) => {
